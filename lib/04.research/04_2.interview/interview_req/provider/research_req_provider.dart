...
import 'package:intermission_project/04.research/04_2.interview/interview_req/repository/research_req_repository.dart';

// Provider 정의
final researchReqStateNotifierProvider = StateNotifierProvider<ResearchReqStateNotifier, ResearchReqModel?>((ref) {
  return ResearchReqStateNotifier(repository: ref.watch(researchReqRepositoryProvider));
});

// StateNotifier 정의
class ResearchReqStateNotifier extends StateNotifier<ResearchReqModel?> {
