...
abstract class ResearchRepository implements
  ...
  Future<CommonResponse> researchBlock({@Path('id') required String id});
  ...
  Future<CommonResponse> reportResearch({@Path() required String id, @Body() required Map<String, dynamic> reportContent});
