...
import 'package:intermission_project/research/model/content_model.dart';
...
class ResearchStateNotifier
  ...
  Future<CommonResponse> reportResearchNow({required String id, required String reportContent}) async{
    return await repository.reportResearch(id: id, reportContent: ContentModel(reportContent: reportContent).toJson());
  }

  Future<CommonResponse> researchBlock(String id) async {
    try {
      ...
      return Future.error(CommonResponse(message: '차단에 실패했습니다', code: 500));
    }
  }
