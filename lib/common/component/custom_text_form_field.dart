...
class CustomTextFormFieldWithMaxLength extends StatefulWidget {
  final String? hintText;
  final String? errorText;
  final bool obscureText;
  final bool autofocus;
  ...
  const CustomTextFormFieldWithMaxLength({
    this.onlyNumber = false,
    this.showClearIcon = false,
    this.textAlign = TextAlign.start,  // 기본값을 왼쪽으로 설정
    this.textAlignVertical = TextAlignVertical.top,  // 기본값을 상단으로 설정
  ...
  @override
  State<CustomTextFormFieldWithMaxLength> createState() => _CustomTextFormFieldWithMaxLengthState();
}

class _CustomTextFormFieldWithMaxLengthState extends State<CustomTextFormFieldWithMaxLength> {
  bool showErrorText = false;
