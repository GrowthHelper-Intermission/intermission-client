...
import 'package:intermission_project/user/view/signup/certification_test_screen.dart';
import 'package:intermission_project/common/component/appbar/custom_appbar.dart';
...
import 'package:intermission_project/common/component/button/signup_select_button.dart';
import 'package:intermission_project/common/const/type_data.dart';
import 'package:intermission_project/user/component/signup_header.dart';
import 'package:intermission_project/user/provider/signup_user_provider.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (selectedIndustry != null)
                        CommonAskLabel(text: '상세 사업 종사 분야'),
                      if (selectedIndustry != null)
                        Center(
                          child: CustomDropdownButton(
                            key: ValueKey(
