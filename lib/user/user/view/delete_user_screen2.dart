...
class _DeleteUserScreen2State extends ConsumerState<DeleteUserScreen2> {
  ...
  Widget build(BuildContext context) {
    ...
    void initState() {
      ...
      // 텍스트 컨트롤러에 리스너 추가
      currentPasswordController.addListener(_validatePasswords);
    }

    @override
    void dispose() {
      currentPasswordController.removeListener(_validatePasswords);
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                SignupAskLabel(text: '비밀번호를 입력해 주세요!'),
                CustomTextFormField(
                ...
                SignupAskLabel(text: '탈퇴 사유를 선택해 주세요!'),
                CustomCheckBox(
                  isAgree: isDifficult,
                  title: '앱이 이용하기 어려워요',
                  onChanged: (value) {
